...
{
  float torque = 0*9.81*sin(elevation_angle*PI/180);
  return torque;
}
...
//void reset_motor_angle(Gemini_Teensy41 motor)
//{
//  for (int i = 0; i < 20; i++)
//  {
//    motor.read_multi_turns_angle();
//    motor.receive_CAN_data();
//    delay(10);
//    motor.motorAngle_offset = motor.motorAngle_raw;
//  }
//}

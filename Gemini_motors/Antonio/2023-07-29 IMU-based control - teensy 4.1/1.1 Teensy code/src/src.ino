...
Gemini_Teensy41 m1(Motor_ID1, CAN_ID, Gear_ratio); //Create motor object 
Gemini_Teensy41 m2(Motor_ID2, CAN_ID, Gear_ratio); //Create motor object
...
void setup()
{
  ...
  //reset_motor_angle(m1);
  //reset_motor_angle(m2);

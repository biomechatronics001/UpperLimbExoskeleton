...
uint32_t Motor_ID1 = 2; //1 Motor Can Bus ID, left leg, loadcell: port 1, positive current = extension // updated on 2022-04-01 2
uint32_t Motor_ID2 = 1; //2 Motor Can Bus ID, right leg, loadcell: port 2, positive current = flexion // updated on 2022-04-01 3
...
Gemini_Teensy36 m1(Motor_ID1, CAN_ID, Gear_ratio, Maxspeed_position); //Create motor object see Motor_Control_Pediatric_V2.h
Gemini_Teensy36 m2(Motor_ID2, CAN_ID, Gear_ratio, Maxspeed_position); //Create motor object see Motor_Control_Pediatric_V2.h

//#ifndef _MOTOR_CONTROL_Pediatric_V2_H
//#define _MOTOR_CONTROL_Pediatric_V2_H
#include <FlexCAN.h>
#include <Arduino.h>
...
class Motor_Control_Pediatric_V2
{
  public:
    ...
    Motor_Control_Pediatric_V2(uint32_t id, int Can_id,double Gear_ratio);
    ~Motor_Control_Pediatric_V2();
    void init_motor();
